...
📂Estructura del Repositorio </br> El contenido está organizado por la tecnología principal o la plataforma de Cisco:├── ansible/                  # Playbooks y roles de Ansible para configuración.
├── python/</br>
